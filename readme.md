...
<div align="center">
  ...
  <h3 align="center">GUTTER RAT</h3>

  <p align="center">
    A nft minting site made with React & Solidity.
    <br />
    <br />
...
This project is called Gutter Rat. User can mint their ethereum coin from this site.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/Gutter-rat.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/Gutter-rat.git)
